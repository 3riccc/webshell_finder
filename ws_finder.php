...
<a align="center" class="btn btn-lg btn-success" href="?find=1&level=1" role="button"><h4 align="center">以顶级安全开始检验(误报率高、不推荐)</h4></a><hr/>
...
function checkFile($thisFile,$level){
